...
export const ProductList: React.FC = () => {
  ...
  const filtered = products.filter((p) => {
    ...
    const matchesType =
      filterType === 'all' ||
      (filterType === 'DIGITAL' && p.productType === 'DIGITAL') ||
      (filterType === 'PHYSICAL' && p.productType !== 'DIGITAL');
      ...
      <div className="bg-white p-4 rounded-2xl border border-slate-200/80 flex flex-col sm:flex-row gap-3 items-center justify-between shadow-xs">
        ...
        <div className="flex flex-wrap items-center gap-2.5 w-full sm:w-auto">
          <select
            ...
            className="text-xs px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#9A80BD] font-medium"
          >
            <option value="all">Todos los tipos</option>
            <option value="PHYSICAL">Solo Físicos</option>
            <option value="DIGITAL">Solo Diseños PDF</option>
          </select>
                    ...
                    <td className="py-3 px-4">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {p.productType === 'DIGITAL' && (
                          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-pink-100 text-pink-700 font-bold text-[10px]">
